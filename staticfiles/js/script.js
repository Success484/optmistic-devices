(function ($) {
  ...
  $(document).ready(function () {
    ...
    var swiper = new Swiper("#productCarousel", {
      loop: true,
      navigation: {
        nextEl: "#productCarousel .swiper-button-next",
        prevEl: "#productCarousel .swiper-button-prev",
      },
      breakpoints: {
        0: {
          slidesPerView: 2,
...
const mobileNav = document.querySelector(".nav2-hamburger");
const navbar = document.querySelector(".nav2-menubar");

const toggleNav = () => {
  navbar.classList.toggle("nav2-active");
  mobileNav.classList.toggle("nav2-hamburger-active");
};
